...
deprecated_funcs = {
    ...
    'xmlValidate': True,
    'xmlXPathAddValues': True,
    'xmlXPathCeilingFunction': True,
    'xmlXPathCompareValues': True,
    'xmlXPathConcatFunction': True,
    'xmlXPathContainsFunction': True,
    'xmlXPathDivValues': True,
    'xmlXPathEqualValues': True,
    'xmlXPathEvalExpr': True,
    'xmlXPathFalseFunction': True,
    'xmlXPathFloorFunction': True,
    'xmlXPathFreeParserContext': True,
    'xmlXPathIdFunction': True,
    'xmlXPathInit': True,
    'xmlXPathIsNodeType': True,
    'xmlXPathLangFunction': True,
    'xmlXPathLocalNameFunction': True,
    'xmlXPathModValues': True,
    'xmlXPathMultValues': True,
    'xmlXPathNamespaceURIFunction': True,
    'xmlXPathNewParserContext': True,
    'xmlXPathNextAncestor': True,
    'xmlXPathNextAncestorOrSelf': True,
    'xmlXPathNextAttribute': True,
    'xmlXPathNextChild': True,
    'xmlXPathNextDescendant': True,
    'xmlXPathNextDescendantOrSelf': True,
    'xmlXPathNextFollowing': True,
    'xmlXPathNextFollowingSibling': True,
    'xmlXPathNextNamespace': True,
    'xmlXPathNextParent': True,
    'xmlXPathNextPreceding': True,
    'xmlXPathNextPrecedingSibling': True,
    'xmlXPathNextSelf': True,
    'xmlXPathNormalizeFunction': True,
    'xmlXPathNotEqualValues': True,
    'xmlXPathParseNCName': True,
    'xmlXPathParseName': True,
    'xmlXPathRoot': True,
    'xmlXPathRoundFunction': True,
    'xmlXPathStartsWithFunction': True,
    'xmlXPathStringLengthFunction': True,
    'xmlXPathSubValues': True,
    'xmlXPathSubstringAfterFunction': True,
    'xmlXPathSubstringBeforeFunction': True,
    'xmlXPathSubstringFunction': True,
    'xmlXPathTranslateFunction': True,
    'xmlXPathTrueFunction': True,
    'xmlXPathValueFlipSign': True,
